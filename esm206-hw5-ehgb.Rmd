...
Regarding the locations where salamanders were observed in Mack Creek in 2017, there is not a significant effect of forest condition (old growth or clear cut) on where in the channel salamanders are found.

A chi-square test indicates that there is no significant association between forest condition (clear cut vs. old growth) and salamander location (cascade, side channel, or pool). (include in-line referencing)
