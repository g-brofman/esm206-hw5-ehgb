...
salamander_line <- ggplot(data = salamanders_counted,
  ...
  ggtitle("Annual count of Pacific giant salamanders (Onchorhyncus clarkii)", "Clear cut vs. old growth sections of Mack Creek, OR (1993-2017)")

salamander_line
```
***Figure 1:** Relative salamander abundance between clear cut and old growth sections of the Mack Creek drainage in the western foothills of the Oregon Cascades*
...
# Small effect size
```
A Levene's Test revealed no significant difference in weight variances between pools, cascades, and side channels at the 0.05 significance level, so an ANOVA is warranted
